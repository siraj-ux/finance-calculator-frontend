...
export default function MutualFundCalculator() {
  ...
  const calculate = async () => {
    ...
    try {
      ...
      const res = await fetch(`${apiUrl}/api/calculators/mutual-fund`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ lumpsumInvestment, monthlyInvestment, annualReturnRate, timePeriodYears })
      });
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:px-8 max-w-5xl">
      <h1 className="text-3xl font-bold mb-8">Mutual Fund Calculator</h1>
